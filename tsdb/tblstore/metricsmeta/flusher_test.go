...
func Test_MetricsMetaFlusher(t *testing.T) {
	...
	metaFlusher := NewFlusher(nopKVFlusher)
	// write only tags
	...
	assert.Equal(t, []byte{
		0x3, 0x1, 0x2, 0x66, 0x33, 0x4, 0x2, 0x2, 0x66, 0x34, 0x0, 0x0, 0x0, 0x0},
		nopKVFlusher.Bytes())
	...
	assert.Equal(t, []byte{
		0x2, 0x6b, 0x31, 0x1, 0x0, 0x0, 0x0, 0x3, 0x1, 0x2, 0x66, 0x33, 0x7, 0x0, 0x0, 0x0},
		nopKVFlusher.Bytes())
