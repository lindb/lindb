...
func (flusher *flusher) getSlice() *[]int {
	return intPool.Get().(*[]int)
}

func (flusher *flusher) putSlice(s *[]int) {
	*s = (*s)[:0]
	intPool.Put(s)
}

func (flusher *flusher) sortSeriesIDs() {
...
// FlushTagKey ends writing the tagValues
func (flusher *flusher) FlushTagValue(tagValue string, bitmap *roaring.Bitmap) {
...
// FlushTagKey ends writing the tagValues
func (flusher *flusher) FlushTagKey(tagKey string) {
...
func (flusher *flusher) resetVersionContext() {
...
// FlushVersion ends writes a version block
func (flusher *flusher) FlushVersion(version series.Version, timeRange timeutil.TimeRange) {
	//////////////////////////////////////////////////
	// Reset
	//////////////////////////////////////////////////
...
func (flusher *flusher) RecordVersionOffset(version series.Version, startPos int) {
...
func (flusher *flusher) finishVersion(startPos, dictBlockOffsetPos int) {
...
// FlushMetricID ends write a full metric-block
func (flusher *flusher) FlushMetricID(metricID uint32) error {
	defer flusher.Reset()
	//////////////////////////////////////////////////
