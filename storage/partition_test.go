...
func TestSegment_GetOrCreateDataFamily(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			prepare: func(_ *partition) {
				newDataFamilyFunc = func(shard Shard, _ Partition,
	...
	cases := []struct {
		...
		},
		{
			...
			prepare: func(_ *partition) {
				...
				newDataFamilyFunc = func(shard Shard, _ Partition, interval timeutil.Interval,
