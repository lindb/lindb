...
type SQLParserVisitor interface {
	...
	// Visit a parse tree produced by SQLParser#streamingDMLStement.
	VisitStreamingDMLStement(ctx *StreamingDMLStementContext) interface{}

	// Visit a parse tree produced by SQLParser#streamingDDLStement.
	VisitStreamingDDLStement(ctx *StreamingDDLStementContext) interface{}

	// Visit a parse tree produced by SQLParser#dropStreamingJob.
	VisitDropStreamingJob(ctx *DropStreamingJobContext) interface{}
	...
	// Visit a parse tree produced by SQLParser#dropStreaming.
	VisitDropStreaming(ctx *DropStreamingContext) interface{}
	...
	// Visit a parse tree produced by SQLParser#retentionProps.
	VisitRetentionProps(ctx *RetentionPropsContext) interface{}

	// Visit a parse tree produced by SQLParser#engineOption.
	VisitEngineOption(ctx *EngineOptionContext) interface{}

	// Visit a parse tree produced by SQLParser#retentionOptions.
	VisitRetentionOptions(ctx *RetentionOptionsContext) interface{}
	...
	// Visit a parse tree produced by SQLParser#appAnnotation.
	VisitAppAnnotation(ctx *AppAnnotationContext) interface{}

	// Visit a parse tree produced by SQLParser#annotation.
	VisitAnnotation(ctx *AnnotationContext) interface{}

	// Visit a parse tree produced by SQLParser#annotation_element.
	VisitAnnotation_element(ctx *Annotation_elementContext) interface{}
