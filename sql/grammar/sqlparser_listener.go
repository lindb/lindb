...
type SQLParserListener interface {
	...
	// EnterStreamingDMLStement is called when entering the streamingDMLStement production.
	EnterStreamingDMLStement(c *StreamingDMLStementContext)
	...
	// EnterDropStreaming is called when entering the dropStreaming production.
	EnterDropStreaming(c *DropStreamingContext)
	...
	// ExitStreamingDMLStement is called when exiting the streamingDMLStement production.
	ExitStreamingDMLStement(c *StreamingDMLStementContext)
	...
	// ExitDropStreaming is called when exiting the dropStreaming production.
	ExitDropStreaming(c *DropStreamingContext)
