...
type CreateJobTask struct {
	...
	statement *tree.CreateJob
}

func NewCreateJob(metaMgr meta.MetadataManager, statement *tree.CreateJob) Task {
...
func (c *CreateJobTask) Execute(ctx context.Context) error {
	...
	return c.metaMgr.CreateJob(ctx, streaming, c.statement.Name, c.statement.String())
}

// Name implements [Task].
func (c *CreateJobTask) Name() string {
	return "CREATE JOB"
}
