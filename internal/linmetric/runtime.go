...
func newRuntimeObserver() *runtimeObserver {
	...
	observer := &runtimeObserver{
		...
		allocBytesTotalCounter: memoryScope.NewCounter("alloc_bytes_total"),
		sysBytesGauge:          memoryScope.NewGauge("sys_bytes"),
		looksUpCounter:         memoryScope.NewCounter("lookups_total"),
		mallocsTotalCounter:    memoryScope.NewCounter("mallocs_total"),
		freesTotalCounter:      memoryScope.NewCounter("frees_total"),
